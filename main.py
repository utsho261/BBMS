...
def user_panel(root, notebook):
    ...
    tk.Button(user_frame, text="Log Out", command=lambda: logout(root, notebook)).grid(row=2, column=0, padx=10, pady=10, sticky='w')
...
def get_districts():
    return [
        "Bagerhat", "Barguna", "Barishal", "Brahmanbaria", "Bandarban", "Bhola",
        "Bogra", "Chandpur", "Chattogram", "Chuadanga", "Cox's Bazar",
        "Dhaka", "Dinajpur", "Faridpur", "Gopalganj", "Gazipur", "Habiganj", "Hatiya",
        "Jamalpur", "Jashore", "Jhalokati", "Jhenaidah", "Joypurhat", "Kagrachari",
        "Kishoreganj", "Kurigram", "Kushtia", "Lakshmipur", "Lalmonirhat", "Magura",
        "Manikganj", "Meherpur", "Moulvibazar", "Mymensingh", "Naogaon", "Narail",
        "Narsingdi", "Netrakona", "Nilphamari", "Noakhali", "Pabna", "Panchagarh",
        "Patuakhali", "Pirojpur", "Rajbari", "Rajshahi", "Rangamati", "Rangpur",
        "Satkhira", "Sherpur", "Shariatpur", "Shyamnagar", "Sirajganj", "Sylhet",
        "Tangail", "Thakurgaon", "Uttara", "Sunamganj", "Sylhet", "Tangail",
        "Thakurgaon"
    ]
